      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-xs">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between font-bold text-slate-700">
            ...
            <span className="text-[#16A6A1] font-black">Rs. {(filters.maxBudget * 300).toLocaleString()} <span className="text-slate-400 font-normal text-[10px]">(${filters.maxBudget})</span></span>
          </div>
          <input
            type="range"
            min={20}
          ...
          <div className="flex justify-between text-[10px] text-slate-400 font-bold">
            <span>Rs. 6,000 (Budget)</span>
            <span>Rs. 24,000 (Comfort)</span>
            <span>Rs. 45,000+ (Luxury)</span>
          </div>
        </div>
